								...
								<div className="col-7 d-flex justify-content-end">
									<span className="pt-1 ">
										<Link to={`/edit-contact/${item.id}`}>
											<button type="button" className="btn btn mx-4" >
												<i className="fa-solid fa-pencil"></i>
											</button>
										</Link>
										<button type="button" onClick={()=>setUserDelete(item.id)} className="btn btn" data-bs-toggle="modal" data-bs-target="#exampleModal">
